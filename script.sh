...
echo "unzip status: $?"
VERSS="$(lynx -listonly -nonumbers -dump https://www.minecraft.net/en-us/download/server/bedrock |grep 'linux'|sed 's|.zip||g'|sed 's|/bin-linux/||g'|sed 's|https://||g'|sed 's|minecraft.azureedge.net||g')"
